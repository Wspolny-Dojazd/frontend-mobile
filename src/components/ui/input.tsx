...
const Input = React.forwardRef<React.ElementRef<typeof TextInput>, InputPropsWithSections>(
  (
    ...
    return (
      <View
        className={cn(
          'flex flex-row items-center rounded-md border border-input bg-background',
        ...
        <TextInput
          ref={ref}
          className={cn(
            'native:h-12 native:text-lg native:leading-[1.25] h-10 flex-1 bg-transparent px-1',
            'text-base text-foreground file:border-0 file:bg-transparent file:font-medium',
            'placeholder:text-muted-foreground web:py-2',
